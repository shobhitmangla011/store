...
import { Builder, Connect1, Connect2, Connect3, Connect4,Group39 , Register, India, bid,aboutus, grow , Payment} from "./images/icon";
...
const FrontPage = () => {
    ...
    <div>
        ...
        <div className="description">
            <div className="description1">Welcome to<br/></div>
            <div className="description2">Infrastore</div>
        <p className="welcome-desc"><br />One stop shop for all building and
        <br />construction material</p>
        </div>
        <div className="About us">
            ...
            <p className="about-us-desc">Infrastore is a tech based company trying to change the procurement process of construction and real estate business.</p>
            <p className="about-us-desc1">InfraStore is responsible for offering genuine products and economics of scale on material pricing.</p>
            <p className="about-us-desc2">Additionally, our customer can use INFRABID platform to discover new growth opputunities across public & private tenders, reverse and forward auction on machineries and products.</p>
        </div>  
       <div className="ourproduct">
        ...
        <div class="background">
            <div className="partner with us">
                    ...
                    <p className="partnerwithus">Partnering with us without any hassles fee and get instant access to Pan India market. You can sell small or bulk quantity , get access to our bidding platform and grow your business without disturbing your core product.</p>  
        
            <div class="container team">
                <div class="row">
                    <div class="card col-lg-1 text-center">
                        <img class="card-img-top fluid" src={Register} alt="Card image" />
                        <div class="card-body">
                    ...
                    <div class="card col-lg-1 text-center">
                        <img class="card-img-top fluid" src={Payment} alt="Card image" />
                        <div class="card-body">
